...
public abstract class AbstractBaseSprite extends ISprite{
	protected double dx;
	protected double dy;
	...
	public AbstractBaseSprite(double x, double y, double width, double height) {
	...
	public boolean equals(Object o) {
		if (o instanceof AbstractBaseSprite) {
			return shape.equals(((AbstractBaseSprite) o).getShape());
		} 
		return false;
