...
public class ClassMethodVisitorTest {
	...
	private static final ArrayList<MethodRecord> EXPECTED_RESULT = new ArrayList<MethodRecord>(Arrays.asList(new MethodRecord[] {
	...
	public void testGettingName() throws IOException, ClassNotFoundException {
		...
		assertEquals(EXPECTED_RESULT, classMethodVisitor.getMethods());
	}
}
